  ...
  app.post("/api/admin/clients", requireAuth, upload.single('logo'), async (req: Request, res: Response) => {
    try {
      ...
      const client = await storage.createClient({
        ...
        notificationPhoneNumber: validated.notificationPhoneNumber || null,
        notificationTime: validated.notificationTime || null,
        notificationDays: validated.notificationDays || null,
        logoPath,
